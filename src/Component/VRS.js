...
export const ViewRegStud = (prop) => {
  ...
  //State is object which contain the information of Component and update this componenet state with
  //passgae of time 
  ...
  {
    //using setRegstud to update the state of VRS Componenet 
    setRegStud(

      //usign filter to chnage rendering of Information 
      //without Current Id show all other information 
        regStud.filter((regStd) => regStd.id !== id )
    )
      ...
      <div id="totalReg-div">
        ...
        regStud.map((regstd , key) => (
            ...
            <tr key={regstd.id}>
                ...
                <button id="list-Delete-btn" onClick={()=>navigate('/view' , regstd)}>View</button>
